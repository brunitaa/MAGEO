...
const UserRequestsPage = () => {
  ...
  const fetchUserRequests = async (userID) => {
    try {
      ...
      console.error(
        "Error al recuperar las solicitudes de eventos del usuario:",
        error
      );
    }
  };
  ...
  return (
    <div className="flex">
      ...
      <section className="flex-grow  items-center">
        <h1 className="text-3xl font-bold mb-4" style={{ padding: "20px" }}>
