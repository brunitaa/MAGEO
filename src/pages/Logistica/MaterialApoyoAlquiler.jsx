...
function MaterialApoyoAlquiler() {
  const { eventId } = useParams();
    ...
    return(
      ...
      <h3 className="text-2xl font-bold mb-4" style={{ margin: '10px 20px' }}>2.4.1 Materiales de Apoyo (Alquiler/Compra)</h3>
    ...
    <table className="table-auto">
      <thead>
        ...
        <th className="px-4 py-2"><Label>Ítem</Label></th>
                 ...
                 <th className="px-4 py-2"><Label>Unidad</Label></th>
      ...
      <tbody>
        ...
        <tr>
          <td className="border px-4 py-2">Credenciales personalizados</td>
          <td className="border px-4 py-2">
            <input
              className="shadow appearance-none border rounded w-full py-1 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
              type="number"
    ...
    <h3 className="text-2xl font-bold mb-4" style={{ margin: '10px 20px' }}>2.4.2 Otros Materiales de Apoyo (Alquiler/Compra)</h3>
    <div className="bg-white flex Ítems-center justify-between mt-4">
    <table className="table-auto">
        <thead>
          <tr>
