...
function MobiliarioAlquiler() {
  const { eventId } = useParams();
    ...
    return(
      ...
      <h3 className="text-2xl font-bold mb-4" style={{ margin: '10px 20px' }}>2.2.1 Mobiliario y Servicios (Alquiler/Compra)</h3>
    ...
    <table className="table-auto">
      ...
      <tbody>
        <tr>
          <td className="border px-4 py-2">Faldón para mesa de 10 personas </td>
        ...
        <tr>
          <td className="border px-4 py-2">Juego de vajillas para almuerzo  (por persona) </td>
          <td className="border px-4 py-2">
            <input
              className="shadow appearance-none border rounded w-full py-1 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
              type="number"
        ...
        <tr>
          <td className="border px-4 py-2">Juego de vajillas para desayuno  (por persona) </td>
          <td className="border px-4 py-2">
            <input
              className="shadow appearance-none border rounded w-full py-1 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
              type="number"
        ...
        <tr>
          <td className="border px-4 py-2">Mantel para mesa de 10 personas </td>
          <td className="border px-4 py-2">
            <input
              className="shadow appearance-none border rounded w-full py-1 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
              type="number"
        ...
        <tr>
          <td className="border px-4 py-2">Mesa rectangular para 10 personas </td>
          <td className="border px-4 py-2">
            <input
              className="shadow appearance-none border rounded w-full py-1 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
              type="number"
    ...
    <br></br>
    <h3 className="text-2xl font-bold mb-4">2.2.2 Otros Mobiliario y Servicios (Alquiler/Compra)</h3>
