...
function EditRequestPage() {
  ...
  const handleSubmit = async (event) => {
    ...
    if (currentDate >= threeBusinessDaysAhead) {
      alert(
        "No es posible editar el evento si faltan menos de 3 días hábiles para su realización."
      );
      return;
    }
    ...
    if (fechaEvento - fechaSolicitud < unaSemanaEnMS) {
      alert(
        "No se puede editar la solicitud cuando falta menos de una semana para el evento."
      );
      return;
    }
    ...
    try {
      ...
      alert(
        "Ocurrió un error al actualizar el evento. Por favor, inténtalo de nuevo más tarde."
      );
    }
  };
    ...
    <div className="flex">
      ...
      <section className="bg-grey-100 min-h-screen flex justify-center Ítems-center">
        <div className="min-h-screen">
          <form
            className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 max-w-4xl mx-auto"
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4 w-full h-full">
              ...
              <div className="mb-4">
                ...
                >
                  <option value="Mod1 P1 Salade de Consejo">
                    Mod. 1 - P1 - Sala de Consejo
                  </option>
                  <option value="Mod1 P1 Sala de ReunionAdministrativa">
                    Mod. 1 - P1 - Sala de Reunión Dirección Administrativa
                  </option>
                  <option value="Mod1 P1 Sala de Conferencia">
                    Mod. 1 - P1 - Sala de Conferencia
                  </option>
                  <option value="Mod1 P2 Sala de ReunionVecerectorado">
                    Mod. 1 - P2 - Sala de Reunión Vicerectorado{" "}
                  </option>
                  <option value="Mod1 P7 Laboratorio_Neuromarketing">
                    Mod. 1 - P7 - Laboratorio NeuroMarketing
                  </option>
                  <option value="Mod1 P5 Aula Smart">
                    Mod. 1 - P5 - Aula Smart
                  </option>
                  <option value="Mod2 P1 Laboratorio de Cata Sensorial">
                    Mod. 2 - P1 - Laboratorio de Cata Sensorial
                  </option>
                  <option value="Mod2 PB Laboratorio Gastronomia">
                    Mod. 2 - PB - Laboratorios Gastronomia{" "}
                  </option>
                  <option value="Mod3 PB Auditorio 1">
                    Mod. 3 - PB - Auditorio 1
                  </option>
                  <option value="Mod3 PB Auditotio 2">
                    Mod. 3 - PB - Auditorio 2
                  </option>
                  <option value="Mod3A Exterior Pasarela">
                    Mod. 3 - Exterior Pasarela
                  </option>
                  <option value="Mod3A P2 Aula de Video Conferencia">
                    Mod. 3A - P2 - Aula de Video Conferencia
                  </option>
                  <option value="Mod3A_PB_Hall_de_Ingreso">
                    Mod. 3A - PB - Hall de Ingreso{" "}
                  </option>
                  <option value="Mod3B Pasillo">Mod. 3B - PB - Pasillo </option>
                  <option value="Mod3C P3 Laboratorio Mesa Anatómica">
                    Mod. 3C - P3 - Laboratorio Mesa Anatómica
                  </option>
                  <option value="Mod4 P4 FabLab">Mod. 4 - P4 - FabLab </option>
                  <option value="Mod4 PB Centro de Computo">
                    Mod. 4 - PB - Centro de Computo
                  </option>
                  <option value="Mod7 PB Laboratorio de Tecnologia">
                    Mod. 7 - PB - Laboratorio de Tecnologia{" "}
                  </option>
                  <option value="EXT. Teatro al Aire Libre">
                    EXT. Teatro al Aire Libre{" "}
                  </option>
                  <option value="EXT. Frontis del campus">
                    EXT. Frontis del Campus{" "}
                  </option>
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  id="externalLocation"
                  type="text"
                  defaultValue={eventData.lugar_externo}
                />
              </div>
              <div className="mb-4">
                <Label
              ...
              <div className="mb-4">
                ...
                >
                  ...
                  <option value="Comunicacion">Comunicación</option>
                  <option value="Direccion de Carrera">
                    Dirección de Carrera
                  </option>
                  <option value="Administracion y Marketing">
              ...
              <div className="mb-4">
                ...
                <select
                  ...
                  required
                >
                  <option value="Estudiantes Univalle">
                    Estudiantes Univalle
                  </option>
                  <option value="Padres de Familia Univalle">
                    Padres de Familia Univalle
                  </option>
                  <option value="Administracion">Administración</option>
                  <option value="Docentes">Docentes</option>
                  <option value="Estudiantes colegio">
                    Estudiantes de Colegio
                  </option>
                  <option value="Padres familia colegios">
                    Padres de Familia de Colegios
                  </option>
